package com.practical.spring.security.authserver.config;
...
@Configuration
public class JwtOAuth2AuthorizationServerSecurityConfiguration {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient myClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .scope("WRITE")
                .build();
        RegisteredClient myClient2 = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("client2")
                ...
                .scope("READ")
                .build();
        return new InMemoryRegisteredClientRepository(myClient, myClient2);
    }
...
//    }
    ...
    // Define a unique issuer URL for our Authorization Server
    @Bean
